...
line_items:
    ...
    {resolved_product_codes?}. When it provides a final code for a product,
    use that resolved code as the line's "item"/"sku" instead of the raw
    tech-spec code. If a product has no resolved code, keep the tech-spec
    value. Do not invent codes.
